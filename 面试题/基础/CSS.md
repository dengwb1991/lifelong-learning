...
父级宽度为 200px, 内由三个元素分别是 A: 50px (flex-grow 0)、B: 50px (flex-grow 1) C: 40px (flex-grow 2)

已知剩余宽度为 200 - (50 + 50 + 40) = 60px，分别被 flex-grow 1 和 2的元素分比例，相加共3份 B占 1份、C占 2份
A：50 + (60 / 3) * 0
B: 50 + (60 / 3) * 1
C: 40 + (60 / 3) * 2
...
父级宽度为 400px, 内由三个元素分别是 A: 250px (flex-shrink 1)、B: 150px (flex-shrink 1) C: 140px (flex-shrink 2)

已知超出宽度为 250 + 150 + 140 - 400 = 140px，分别要被 A: 1、B: 1、C: 2 消化掉

1）求所有项目的乘集

250 * 1 + 150 * 1 + 140 * 2 = 680px
