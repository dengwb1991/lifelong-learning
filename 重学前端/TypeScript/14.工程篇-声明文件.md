...
本章主要介绍在 TS 文件中如何引入外部类库以及如何为它们编写声明文件。

本篇文章会接触到 JavaScript模块化 的一些基础知识，若您还对它不了解，可以点击[了解 JavaScript模块化](https://notes.dengwb.com/notes/jsModular.html) 进行阅读。

## 介绍

类库大致分为三类，分别为**全局类库**、**模块类库**、**UMD类库**
...
:::tip
可在 `http://microsoft.github.io/TypeSearch/` 中查询类库是否有声明文件
可在 `http://definitelytyped.org/` 中了解如何发布声明文件
:::
